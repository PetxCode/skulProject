			...
			<Wrapper>
				...
				<Top>
					...
					<Contents>
						...
						<Detail>
							<Name>Chukwusah Peter</Name>
							<Bio>
								To do something specific upon the clearResults action being
								dispatched, I had to introduce a new reducer (called appReducer
								in this example)Cinematographer, Post production, Tech
								entrepreneur, public speaker and a serial entrepreneur.
							</Bio>
							<WebSite href="#">telephone contact</WebSite>
						</Detail>
					</Contents>
				</Top>
