...
const UpdateAdminProfile = () => {
	...
	const yupSchema = yup.object().shape({
		schoolProfile: yup.string().required("School profile has to be filled"),
	...
	const onSubmit = handleSubmit(async (val) => {
		console.log(val);
		const { schoolProfile, displayName, phoneNumber } = val;
		...
		<Container>
			<Wrapper>
				...
				<MainCard onSubmit={onSubmit}>
					<LogoTitle1>Update School's Profile</LogoTitle1>
					<NameArea>
						<InputTitle>School Profile</InputTitle>
						<InputArea
