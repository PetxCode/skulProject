...
const AddExpens = () => {
	...
	const yupSchema = yup.object().shape({
		itemName: yup.string().required("School profile has to be filled"),
		itemQuantity: yup.string().required("School name has to be filled"),
		expenseAmount: yup
			.number()
			.integer()
			.required("full name has to be entered"),
		sourcePurchase: yup.string().required("displayed name has to be filled"),
	});
		...
		<Container>
			<Wrapper>
				<MainCard onSubmit={onSubmit}>
					<LogoTitle1>Add Expense</LogoTitle1>

					<Name>
						<InputTitle>Item Name</InputTitle>
						<Input placeholder="e.g: Water Bottle" {...register("itemName")} />
					</Name>
					<Error>{errors?.itemName?.message}</Error>
					<Hold>
						<PhoneData>
							<Phone>
								<InputTitle>Item Quantity</InputTitle>
								<Input placeholder="e.g: 5" {...register("itemQuantity")} />
							</Phone>
						...
						<PhoneData>
							<Phone1>
								<InputTitle>Expense Amount</InputTitle>
								<Input placeholder="e.g: 2000" {...register("expenseAmount")} />
							</Phone1>
					...
					<Name>
						<InputTitle>Source of Purchase</InputTitle>
						<Input
							placeholder="e.g: CodeLab Int'l"
